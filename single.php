...
<div class="services-breadcrumb">
	<div class="agile_inner_breadcrumb">
	   <ul class="w3_short">
			...
			<li>Electronic Bid-An Online Auction System</li>
		</ul>
	</div>
</div>
<!-- //w3_short -->
					...
					<div class="left-blog left-single">
						<div class="blog-left">
							<div class="single-left-left">
								<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on June 2, 2015 &nbsp;&nbsp; <a href="contact.php">Comments</a></p>
								<img src="images/s1.jpg" alt="" />
							</div>
							<div class="blog-left-bottom">
							<font color="Blue">
							<h3>About Online Auction</h3>
						...
						<div class="w3response wthree">
							...
							<div class="media w3response-info">
								<div class="media-left w3response-text-left">
									<a href="#">
										<img class="media-object" src="images/lady.png" alt="">
									</a>
									<h5><a href="#">Admin</a></h5>
								</div>
								<div class="media-body w3response-text-right">
									<p>Suneha Muskan an admin of this auction site.</p>
									<ul>
										<li>dec 21, 2017</li>
