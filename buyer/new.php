...
<div class="container-fluid">
	...
	<?php include('connection.php');
	 ...
	 <div class="col-md-2" style=" text-align: center; margin-bottom: 10px; border-radius: 6px;">
	 	<h3 style="text-transform: capitalize;text-align: center; color:black; height: 40px;"><?php echo $fetch['title']; ?></h3>
	 	<div class="col-md-2">
	 	<img src="../seller/photos/<?php echo $fetch['image']; ?>" style="margin-bottom: 10px;" height="150" width="200" class="img-rounded"></a>
	 	</div>
	 	<div class="col-md-6" style="margin-left: 70px;">
	 	<h5 style="size:20;color:#0097A7;font-weight: bold;font-family: georgia;"><?php echo $fetch['username']; ?></h5>
	 	<h5 style="size:20;color:#0097A7;font-weight: bold;font-family: georgia;" "><?php echo $fetch['productname']; ?></h5>
	 	<h5 style="size:20;color:#0097A7;font-weight: bold;font-family: georgia;""><?php echo $fetch['desc']; ?></h5>
	 	<h5 style="size:20;color:#0097A7;font-weight: bold;font-family: georgia;""><?php echo $fetch['postonbefore']; ?></h5>
