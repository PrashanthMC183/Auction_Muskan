...
<div class="container-fluid">
	...
	<?php include('connection.php');
		$sql=mysql_query("select DISTINCT productname,reqid,pro_id,photo,min_range from product,hostproduct,category,subcategory where product.pro_id=hostproduct.prid and hostproduct.`status`='Hosted' and product.subc_id=subcategory.subcid and subcategory.cid=category.cid and category.cname='Artemis Gallery' group by product.`pro_id`"); 
