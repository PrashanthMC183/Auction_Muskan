...
<div class="container-fluid">
	...
	<?php include('connection.php');
		$sql=mysql_query("select DISTINCT productname,reqid,pro_id,photo,min_range from product,hostproduct where product.pro_id=hostproduct.prid and hostproduct.`status`='Hosted'"); 
