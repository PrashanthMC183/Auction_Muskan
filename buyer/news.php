...
<div class="container-fluid">
	...
	<?php include('connection.php');
		$sql=mysql_query("select * from newsreq where `status`='Hosted'"); 
		while($fetch=mysql_fetch_array($sql)){
	 ?>

	 
   <div class="row col-md-12">
	 <div class="col-md-2" style=" text-align: center; margin-bottom: 5px; border-radius: 6px;">
  	 	<h3 style="text-transform: capitalize;text-align: center; color:black; height: 40px;"><?php echo $fetch['title']; ?></h3><br>
  	 	<img src="../seller/photos/<?php echo $fetch['image']; ?>" style="margin-bottom: 10px;" height="150" width="200" class="img-rounded">
	 </div>
	 <div class="col-md-6" style="margin-left: 30px;">
	 	By: <h5 style="font-size:20px;color:#0097A7;font-weight: bold;font-family: georgia;"><?php echo $fetch['username']; ?></h5>
	 	Product: <h5 style="font-size:20px;color:#0097A7;font-weight: bold;font-family: georgia;" "><?php echo $fetch['productname']; ?></h5>
	 	<h5 style="font-size:20px;color:#0097A7;font-weight: bold;font-family: georgia;""><?php echo $fetch['desc']; ?></h5>
	 	Date: <h5 style="font-size:20px;color:#0097A7;font-weight: bold;font-family: georgia;""><?php echo $fetch['postonbefore']; ?></h5>
	 </div>
   </div>
	 <?php } ?>
</div>
...
<script type="text/javascript">
        ...
        <?php
            ...
            $i=1;
            $qry_select=mysql_query("SELECT * FROM `newsreq` where status='Hosted'");
