...
<div class="main-agile">
	<div class="banner-w3l-2">
		...
		<div class="header">
			<div class="logo">
				<h1><a href="index.html"><span>E</span>lectronic<label>Bid</label></a></h1>
			</div>  
		...
		<nav class="cd-stretchy-nav edit-content">
			...
			<ul>
				...
				<li><a href="icons.html" class="active"><span>Icons</span></a></li> 
...
<!-- icons -->
	<div class="w3_wthree_agileits_icons main-grid-border">
		<div class="container">
			<h3 class="title-w3l w3l-2"><span>w</span>eb <span>i</span>cons</h3>
