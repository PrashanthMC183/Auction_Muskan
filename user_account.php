...
<div class="wrapper" style="background-image: url('images/earth.jpg'); ">
<div class="container">
    <br>
    <div class="row">
    <div class="col-md-2"></div>
    	<div class="col-md-8" style="margin-top: 80px;color:white">
           ...
           <div class="tab">
                    ...
                    <button class="tablinks" <?php if($active=="Userlogin") echo 'id="defaultOpen"'?> onclick="openPage(event, 'Userlogin')" style="color:black;">SignIn</button>
                    
                    <button class="tablinks"  <?php if($active=="Register") echo 'id="defaultOpen"'?>  onclick="openPage(event, 'Register' )"  id="defaultOpen" style="color:black;">SignUp</button>
            </div>
