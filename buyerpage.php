...
<div class="main-agile">
	<div class="banner-w3l">
		...
		<nav class="cd-stretchy-nav edit-content">
			...
			<ul>
				<li><a href="index.php" class="scroll active"><span>Home</span></a></li>
				<li><a href="product.php"><span>Products</span></a></li>
				<li><a href="gallery.php"><span>Winners</span></a></li>
				<li><a href="contact.php"><span>Message</span></a></li>
				<li><a href="contact.php"><span>Feedback</span></a></li>
				<li><a href="contact.php"><span>Report</span></a></li>
			</ul> 
