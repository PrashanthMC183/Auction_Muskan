	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i> call us : 8281444145</li>
					
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Bazaar Kart</a></h1>
			</div>
											...
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>All Groceries</h6>
														<li><a href="rice.php">Rice.php</a></li>
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>All Household</h6>
														<li><a href="cook.php">Cookware</a></li>
														<li><a href="dust.php">Dust Pans</a></li>
														<li><a href="mop.php"> Mops </a></li>
													</ul>
												</div>
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Baby Care</h6>
														<li><a href="babysoap.php">Baby Soap</a></li>
														<li><a href="babyoil.php">Baby Oil & Shampoos</a></li>
														<li><a href="babypowder.php"> Baby Powder</a></li>
													</ul>
												</div>
											...
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														...
														<li><a href="softdrink.php">Soft drinks</a></li>
														<li><a href="biscuit.php">Biscuits</a></li>
														<li><a href="choclate.php">Chocolates & Sweets</a></li>
													</ul>
												</div>
		...
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form method="post" action="">
					<input type="text" name="pno" pattern="[0-9]+" max-lenght="10" title="only numbers" placeholder="Enter your phone number" required=" " >
...
<?php
	...
	if(isset($_POST['save'])){
		...
		$sql = mysql_query("SELECT * FROM user where phone='$pno'") or die(mysql_error());
