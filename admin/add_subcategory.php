            ...
            <hr>
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subcname" class="form-control" placeholder="Enter category name">
                    </div>
                 ...
                 <?php 
                        ...
                        if(isset($_POST['save']))
                        {
                            ...
                            $sql=mysql_query("INSERT INTO `subcategory`(`cid`,`subcategory`) VALUES ('$cat_name','$subname')")or die(mysql_error());
                            if($sql)
                            {
                                echo '<script>alert("SubCategory has added"); </script>';
                            }
                            else
                            {
