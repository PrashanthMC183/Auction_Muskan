            ...
            <hr>
                <table class="table table-bordered table-hover" style="border: 1px solid grey;" >
                    <tr>
                        ...
                        <th style="border: 1px solid grey;">PaidDate</th>
                        <th style="border: 1px solid grey;">Subs_id</th>
                        

                    </tr>
                    <?php include('connection.php');
                    $i=1;
                        $sql=mysql_query("select * from sub_payment,user where sub_payment.sellerid=user.user_id") or die(mysql_error());
                        while($row=mysql_fetch_array($sql)) {
                     ?>
                     <tr>
                         <td style="border: 1px solid grey;"><?php echo $i++;?></td>
                         <td style="border: 1px solid grey;"><?php echo $row['fullname']; ?></td>
                         <td style="border: 1px solid grey;"><?php echo $row['amount'];?></td>
                         <td style="border: 1px solid grey;"><?php echo $row['paiddate'];?></td>
                         <td style="border: 1px solid grey;"><?php echo $row['subid'];?></td>
                    </tr>
                     <?php } ?>
                </table>
            </div>
